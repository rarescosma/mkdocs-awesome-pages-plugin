...
class TestArrange(NavigationTestCase):
    ...
    def test_sections(self):
        navigation = self.createAwesomeNavigation(
            [
                ...
                self.section(
                    "A",
                    [self.page("3", "a/3.md"), self.page("4", "a/4.md")],
                    "a",
                ),
                self.section(
                    "B",
                    [self.page("5", "b/5.md"), self.page("6", "b/6.md")],
                    "b",
                ),
        ...
        self.assertNavigationEqual(
            ...
            [
                self.section(
                    "A", [self.page("3", "a/3.md"), self.page("4", "a/4.md")]
                ),
                self.page("1", "1.md"),
                self.section(
                    "B", [self.page("5", "b/5.md"), self.page("6", "b/6.md")]
                ),
                self.page("2", "2.md"),
            ],
        )
    ...
    def test_collapsed(self):
        navigation = self.createAwesomeNavigation(
            [
                self.section(
                    "A",
                    [self.page("1", "a/1.md"), self.page("2", "a/2.md")],
                    "a",
                ),
        ...
        self.assertNavigationEqual(
            ...
            [
                self.page("3", "b/3.md"),
                self.section(
                    "A", [self.page("1", "a/1.md"), self.page("2", "a/2.md")]
                ),
            ],
        )
        self.assertValidNavigation(navigation.to_mkdocs())
    ...
    def test_duplicates(self):
        ...
        self.assertValidNavigation(
            mkdocs_navigation, assert_previous_next=False
        )
