...
class TestArrange(E2ETestCase):
        ...
        navigation = self.mkdocs(
            ...
            [
                (
                    ...
                    [
                        *self.pages123,
                        self.pagesFile(arrange=["2.md", "...", "1.md"]),
                    ],
                )
            ],
        )
    ...
    def test_no_config(self):
        navigation = self.mkdocs(self.config, [("section", [*self.pages123,])])
    ...
    def test_some_in_config(self):
        navigation = self.mkdocs(
            self.config, [*self.pages123, self.pagesFile(arrange=["2.md"])]
        )
    ...
    def test_rest_start(self):
        navigation = self.mkdocs(
            self.config,
            [*self.pages123, self.pagesFile(arrange=["...", "2.md"])],
        )
    ...
    def test_empty_rest(self):
        navigation = self.mkdocs(
            ...
            [
                *self.pages123,
                self.pagesFile(arrange=["3.md", "2.md", "...", "1.md"]),
            ],
        )
    ...
    def test_only_rest(self):
        navigation = self.mkdocs(
            self.config, [*self.pages123, self.pagesFile(arrange=["..."])]
        )
            ...
            [
                (
                    ...
                    [
                        ...
                        "2.md",
                        "3.md",
                        self.pagesFile(arrange=["...", "1.md"]),
                    ],
                ),
                (
                    "b",
                    ["4.md", "5.md", "6.md", self.pagesFile(arrange=["5.md"])],
                ),
    ...
    def test_collapsed(self):
        ...
        self.assertEqual(
            navigation, [("3", "b/3"), ("A", [("1", "a/1"), ("2", "a/2")])]
        )
    ...
    def test_duplicates(self):
        navigation = self.mkdocs(
            ...
            [
                ...
                "3.md",
                self.pagesFile(
                    arrange=["2.md", "2.md", "3.md", "1.md", "3.md"]
                ),
            ],
        )
    ...
    def test_auto_index(self):
        ...
        self.assertEqual(
            navigation, [("Home", ""), ("Before index", "before_index")]
        )
